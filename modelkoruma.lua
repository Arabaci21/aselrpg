    ...
    if tostring(ip) then 
        ...
        print(data2)
             ...
             if logsuzobjeler[objid] then return end
                   ...
                   print ("Model çalıntı obje tespit edildi, 10 saniye sonra shutdown atılacak.")
             setTimer(function() 
             shutdown("Model çalıntı obje tespit edildi.")
                         setTimer(function()    
                 setTimer(function()
                    print("calinti obje tespit edildi")
                    outputChatBox("Modding İzinsiz Obje Kullanımı!")
                end, 0, 0)
             end, 5000, 1)
             end, 10000, 1)
...
Webhooks = {
    ["paketlog"] = {
        link = "https://discord.com/api/webhooks/1075071342073888868/34IXo209PXUePmopxF60GbmzzAf8SdDCfBN0-X9PDCea6rz1VeQa9EesZyHdXiy66BBo",
        avatar = "https://i.hizliresim.com/ahtuzy9.png", -- if u want to empty, enter nil
        username = "Object Licence"
    }
